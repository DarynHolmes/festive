...
**Roles:**
- **Gemini** (custom Gem, `supporting-documentation/gemini-gem.md`) — acts as product owner; defines requirements
- **Claude Code** — implements requirements; encouraged to challenge them

As the project progresses, keep `supporting-documentation/gemini-gem.md` up to date with changes. Remind me to update Gemini with the latest information.
...
4. Update `supporting-documentation/gemini-gem.md` to keep Gemini in sync
