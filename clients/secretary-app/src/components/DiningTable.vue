          ...
          <template v-if="col.name === 'status'">
            <div class="text-center">
              ...
              >
                ...
                >
                  <q-list style="min-width: 180px">
                    <q-item
                      ...
                      @click="emit('toggle-status', props.row.memberId, option.value, props.row.diningRecordId)"
                    >
                      <q-item-section side>
                        <q-icon
                ...
                <q-badge
                  v-if="syncingMemberIds.has(props.row.memberId) || pendingMemberIds.has(props.row.memberId)"
                  floating
                  rounded
                  color="white"
                  class="sync-badge"
...
const statusConfig: Record<DiningStatus, {
  ...
  dining: { label: 'Dining', color: 'positive', textColor: 'white', icon: 'check_circle', iconColor: 'positive' },
  not_dining: { label: 'Not Dining', color: 'blue-grey-6', textColor: 'white', icon: 'cancel', iconColor: 'blue-grey-6' },
